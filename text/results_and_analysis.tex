...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../presentation/img/tazisko.png}    
  \caption{Encoder 4-2-4 hidden activations - Mass point}
  \label{fig:424-test2}
\end{figure}
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../presentation/img/close.png}    
  \caption{Encoder 4-2-4 hidden activations : Close}
  \label{fig:424-test2}
\end{figure}
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../presentation/img/left_top.png}    
  \caption{Encoder 4-2-4 hidden activations - Left top}
  \label{fig:424-test2}
\end{figure}
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../presentation/img/right_top.png}    
  \caption{Encoder 4-2-4 hidden activations - Right top}
  \label{fig:424-test2}
\end{figure}
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{../presentation/img/non-convergent.png}    
  \caption{Encoder 4-2-4 hidden activations - Non-convergent}
  \label{fig:424-test2}
\end{figure}
