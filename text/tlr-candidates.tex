...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.49\textwidth]{img/placeholder.png}  %TODO   
  \includegraphics[width=0.49\textwidth]{img/placeholder.png}  %TODO    
...
%  \includegraphics[width=0.45\textwidth]{img/placeholder.png}  %TODO    
%  \caption{Evolution of the distance between forward and backward hidden activations $dist_{H}^{FB}$~(\ref{sec:our-dist-h-fb}). Further discussion in~(\ref{sec:our-hidden-activation}). }
