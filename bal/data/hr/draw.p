...
set xrange [0:1]
set yrange [0:1]
set terminal pdf enhanced font "arial,10" size 5, 4 crop   
...
plot inpath."_0.csv" using 1:2 with linespoints notitle lw 0.5 pt 3 lt rgb "red",  \
     inpath."_1.csv" using 1:2 with linespoints notitle lw 0.5 pt 3 lt rgb "blue",  \
     inpath."_2.csv" using 1:2 with linespoints notitle lw 0.5 pt 3 lt rgb "green", \
     inpath."_3.csv" using 1:2 with linespoints notitle lw 0.5 pt 3 lt rgb "purple", \
     inpath."_starts.csv" using 1:2 with points notitle pt 5 lt rgb  "black", \
     inpath."_ends.csv" using 1:2 with points notitle pt 4 lt rgb  "black"
